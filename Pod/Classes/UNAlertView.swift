...
open class UNAlertView: UIView {
    ...
    // Button alignment
    open var buttonAlignment       = UNButtonAlignment.horizontal
    ...
    open func addButton(_ title:String, backgroundColor: UIColor, action:@escaping ()->Void) {
    ...
    // Add a button with a title, a background color, a font color and an action
    open func addButton(_ title:String, backgroundColor: UIColor, fontColor: UIColor, action:@escaping ()->Void) {
